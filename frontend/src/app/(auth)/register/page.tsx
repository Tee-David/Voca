...
function RegisterForm() {
  ...
  function handleGoogle() {
    setNotice("Google sign-up is coming soon. Use email for now.");
      ...
      <div className="flex-1 flex flex-col justify-center">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-1.5">
            Start listening to your books and documents
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Name */}
          <div>
            <label htmlFor="name" className="text-sm font-semibold text-foreground block mb-1.5">
              Full name
            </label>
            <input
              id="name"
